...
INSERT INTO faktury (id ,id_klienta, data_wystawienia, wartosc_zamowienia) VALUES (1, 9, '2019-12-10', 346);
...
INSERT INTO faktury (id, id_klienta, data_wystawienia, wartosc_zamowienia) VALUES (2, 1, '2019-12-14', 114);
...
INSERT INTO faktury (id, id_klienta, data_wystawienia, wartosc_zamowienia) VALUES (7, 2, '2019-12-11', 29);
...
INSERT INTO faktury (id, id_klienta, data_wystawienia, wartosc_zamowienia) VALUES (4, 10, '2019-12-18', 5890);
...
INSERT INTO faktury (id, id_klienta, data_wystawienia, wartosc_zamowienia) VALUES (5, 4, '2019-12-27', 276);
...
# ZADANIE NUMER 9
INSERT INTO Ksiazki (tytul, autor, cena, ilosc)
    VALUES ('kariera Nikodema Dyzmy', 'Tadeusz Dołęga-Mostowicz', 100, 30);
INSERT INTO Ksiazki (tytul, autor, cena, ilosc)
    VALUES ('Potop', 'Henryk Sienkiewicz', 200, 20);
INSERT INTO Ksiazki (tytul, autor, cena, ilosc)
    VALUES ('Profesor Wilczur', 'Tadeusz Dołęga-Mostowicz', 15, 40);
INSERT INTO Ksiazki (tytul, autor, cena, ilosc)
    VALUES ('Quo Vadis', 'Henryk Sienkiewicz', 50, 10);

INSERT INTO Klienci (imie, nazwisko, nazwa_firmy, NIP, adres, nr_tel)
    VALUES ('Jan', 'Kowalski', 'Abc', 123, 'Grudziadz ul.Jakas 23', '333444222');

INSERT INTO zamowienie (id_ksiazki, ilosc, wartosc)
    VALUES (9, 30, 3000);
INSERT INTO zamowienie (id_ksiazki, ilosc, wartosc)
    VALUES (10, 10, 2000);
INSERT INTO faktury (id, id_klienta, data_wystawienia, wartosc_zamowienia)
    VALUES (3, 12, '2019-12-30', 5000);
INSERT INTO zamowienia_na_fakturze (id_faktury, id_zamowienia) VALUES (3, 14);
INSERT INTO zamowienia_na_fakturze (id_faktury, id_zamowienia) VALUES (3, 15);

INSERT INTO Klienci (imie, nazwisko, nazwa_firmy, NIP, adres, nr_tel)
    VALUES ('Piotr', 'Nowak', 'ksiegaz', 987, 'Kraków ul.Inna 37', '777999333');
INSERT INTO zamowienie (id_ksiazki, ilosc, wartosc)
    VALUES (11, 40, 450);
INSERT INTO zamowienie (id_ksiazki, ilosc, wartosc)
    VALUES (12, 10, 500);
INSERT INTO faktury (id, id_klienta, data_wystawienia, wartosc_zamowienia)
    VALUES (23434, 13, '2019-12-30', 950);
INSERT INTO zamowienia_na_fakturze (id_faktury, id_zamowienia) VALUES (23434, 16);
INSERT INTO zamowienia_na_fakturze (id_faktury, id_zamowienia) VALUES (23434, 17);
